    ...
    <div class="col">
        <div>
            <div class="d-flex align-items-center justify-content-between bg-secondary rounded p-3 mb-7 border border-gray-900 draggable-handle">
                ...
                <a class="btn btn-sm me-1 p-1" href="{{ route('order.block.most', $event_version->event)}}">
                    <button class="btn btn-lg btn-success p-6" type="button">
                        SEND
                    </button>
                </a>
                @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="d-flex flex-row justify-content-end mt-5 mb-5">
                    <a href="{{route("document.mail",['correo@gmail.com'])}}">
...
<script>
    ...
    tinymce.init({
        ...
        menubar: false,
        statusbar: false,
        content_css: '/assets/plugins/global/plugins.bundle.css,/assets/css/style.bundle.css,/assets/css/custom.css'
    });
 ...
 */
    /* $(document).on('click','#sub_block', function(e){
    ...
    /* const $ventanaModal = $('#send-modal');
    $ventanaModal.on('hidden.bs.modal', function(event) { //ESTA FUNCCION RESETEA EL MODAL CREAR PRODUCTO
        location.reload();
    }); */
</script>
@endsection