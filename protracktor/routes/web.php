...
Route::get('/', function () {
    ...
    Route::get('/order/block/{event}', [OrderController::class, 'block_order'])->name('order.block.most');//datos al modal
    ...
    Route::get('/communication/event/{event}/show', [EventController::class, 'show'])->name('communication.event.show');
    ...
    Route::get('/test', [DocumentController::class, 'test'])->name('document.test');
    Route::get('/test/mail/{event}', [DocumentController::class, 'test_mail'])->name('document.mail');
    Route::get('/testSms', [DocumentController::class, 'testSms'])->name('document.testSms');

    //users controller
    Route::resource('accounts', AdminUserController::class)->names('accounts');
  });
